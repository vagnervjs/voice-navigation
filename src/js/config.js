...
export const CONFIG = {
  VOICE_RECOGNITION: {
    ...
    CONFIDENCE_THRESHOLD: parseFloat(import.meta.env.VITE_VOICE_CONFIDENCE_THRESHOLD) || 0.6,
    MAX_ALTERNATIVES: 3,
    CONTINUOUS: true,
  ...
  API: {
    GEOCODING_BASE_URL: import.meta.env.VITE_GEOCODING_BASE_URL || 'https://maps.googleapis.com/maps/api/geocode/json',
    GOOGLE_MAPS: {
...
export const VOICE_COMMANDS = [
  // Movement commands
  { regex: /\b(go|forward|move forward|ahead)\b/, code: 'MOVE_FORWARD', label: 'move forward' },
  { regex: /\b(back|backward|move back|retreat)\b/, code: 'MOVE_BACKWARD', label: 'move backward' },
  ...
  { regex: /\b(turn left|rotate left|spin left)\b/, code: 'TURN_LEFT', label: 'turn left' },
  { regex: /\b(turn right|rotate right|spin right)\b/, code: 'TURN_RIGHT', label: 'turn right' },
  ...
  { regex: /\b(look down|down|tilt down)\b/, code: 'LOOK_DOWN', label: 'look down' },
